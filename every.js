...
//element as argument, returns true or false. Just like && returns
//a true value only when the expressions on both sides are true,
...
//predicate returns true for any of the elements. They do not process
...
console.log('should be true: ' + every([NaN, NaN, NaN], isNaN));
console.log('should be false: ' + every([NaN, NaN, 4], isNaN));
console.log('should be true: ' + some([NaN, 3, 4], isNaN));
console.log('should be false: ' + some([2, 3, 4], isNaN));
